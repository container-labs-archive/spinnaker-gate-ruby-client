...
module SwaggerClient
  class User
    ...
    attr_accessor :allowed_accounts
    ...
    def hash
      [account_non_expired, account_non_locked, allowed_accounts, authorities, credentials_non_expired, email, enabled, first_name, last_name, roles, username].hash
    end
